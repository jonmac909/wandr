                        ...
                        <div className="flex-1 max-w-md ml-auto">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    value={dest.name}
                                    readOnly
                                    className="w-full pl-10 pr-4 py-2 bg-slate-50 border border-slate-200 rounded-lg text-slate-700"
                                />
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="mb-6">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                {/* eslint-disable-next-line @typescript-eslint/no-explicit-any */}
                                {dest.cityImages.map((city: any, i: number) => (
                    ...
                    <div className="lg:sticky lg:top-24 lg:self-start">
                        ...
                        <div className="space-y-5">
                            ...
                            <div>
                                ...
                                <div className="space-y-2.5">
                                    {/* eslint-disable-next-line @typescript-eslint/no-explicit-any */}
                                    {dest.activities.map((activity: any) => (
                            ...
                            <div>
                                ...
                                <div className="space-y-2.5">
                                    {/* eslint-disable-next-line @typescript-eslint/no-explicit-any */}
                                    {dest.restaurants.map((restaurant: any) => (
