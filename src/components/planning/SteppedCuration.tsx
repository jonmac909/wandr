...
const CITY_ATTRACTIONS: Record<string, { name: string; description: string; rating: number; tags: string[]; image: string }[]> = {
  // Thailand
  'Koh Samui': [
    { name: 'Big Buddha Temple', description: 'Iconic 12-meter golden Buddha statue at Wat Phra Yai with panoramic views.', rating: 4.6, tags: ['Temple', 'Culture', 'Landmark'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Ang Thong Marine Park', description: '42 stunning islands with emerald lagoons, caves, and pristine beaches.', rating: 4.8, tags: ['Nature', 'Beach', 'Adventure'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Wat Plai Laem', description: 'Colorful temple complex featuring an 18-arm Guanyin statue on the water.', rating: 4.7, tags: ['Temple', 'Culture', 'Photography'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Na Mueng Waterfall', description: 'Beautiful two-tiered waterfall in the jungle, great for swimming.', rating: 4.4, tags: ['Nature', 'Waterfall', 'Adventure'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Lamai Night Market', description: 'Vibrant night market with street food, clothes, and local crafts.', rating: 4.5, tags: ['Food', 'Shopping', 'Nightlife'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Pig Island (Koh Madsum)', description: 'Charming island famous for friendly pigs on the beach.', rating: 4.6, tags: ['Beach', 'Unique', 'Family'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Grandfather & Grandmother Rocks', description: 'Unique rock formations on Lamai Beach with interesting shapes.', rating: 4.2, tags: ['Nature', 'Landmark', 'Beach'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Fisherman\'s Village', description: 'Charming area in Bophut with boutiques, restaurants, and Friday night market.', rating: 4.6, tags: ['Shopping', 'Food', 'Nightlife'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Secret Buddha Garden', description: 'Hidden hillside garden with Buddhist statues and jungle views.', rating: 4.5, tags: ['Culture', 'Nature', 'Adventure'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Overlap Stone', description: 'Viewpoint with stunning panoramic views of Lamai Beach.', rating: 4.7, tags: ['Viewpoint', 'Photography', 'Nature'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
  ],
  'Chiang Mai': [
    { name: 'Wat Doi Suthep', description: 'Sacred temple on a mountain with 309 steps and city views.', rating: 4.7, tags: ['Temple', 'Culture', 'Viewpoint'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Elephant Nature Park', description: 'Ethical elephant sanctuary where you can feed and bathe elephants.', rating: 4.9, tags: ['Nature', 'Animals', 'Experience'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Night Bazaar', description: 'Famous night market with handicrafts, food, and entertainment.', rating: 4.5, tags: ['Shopping', 'Food', 'Nightlife'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Old City Temples', description: 'Historic walled city with ancient temples including Wat Chedi Luang.', rating: 4.6, tags: ['Temple', 'History', 'Walking'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Sticky Waterfalls', description: 'Unique limestone waterfall you can climb up - the rocks are not slippery!', rating: 4.7, tags: ['Nature', 'Adventure', 'Unique'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Doi Inthanon', description: 'Thailand\'s highest peak with twin pagodas and cool mountain trails.', rating: 4.8, tags: ['Nature', 'Hiking', 'Viewpoint'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Wua Lai Walking Street', description: 'Saturday night market famous for silver jewelry and local crafts.', rating: 4.6, tags: ['Shopping', 'Culture', 'Nightlife'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Thai Cooking Class', description: 'Learn to cook authentic Thai dishes at a local cooking school.', rating: 4.9, tags: ['Food', 'Experience', 'Culture'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Wat Phra Singh', description: 'Important temple housing the revered Phra Singh Buddha image.', rating: 4.6, tags: ['Temple', 'Culture', 'History'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Grand Canyon Water Park', description: 'Former quarry turned into a fun water park with cliff jumping.', rating: 4.4, tags: ['Adventure', 'Swimming', 'Fun'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
  ],
  'Bangkok': [
    { name: 'Grand Palace', description: 'Stunning royal palace complex with the sacred Emerald Buddha.', rating: 4.7, tags: ['Palace', 'Culture', 'History'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Wat Arun', description: 'Iconic Temple of Dawn with intricate porcelain-covered spires.', rating: 4.8, tags: ['Temple', 'Landmark', 'Photography'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Chatuchak Weekend Market', description: 'One of the world\'s largest markets with 15,000+ stalls.', rating: 4.6, tags: ['Shopping', 'Food', 'Experience'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Khao San Road', description: 'Famous backpacker street with bars, food, and lively nightlife.', rating: 4.3, tags: ['Nightlife', 'Food', 'Social'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Floating Markets', description: 'Traditional markets on canals selling food and goods from boats.', rating: 4.5, tags: ['Culture', 'Food', 'Unique'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Wat Pho', description: 'Temple of the Reclining Buddha - 46 meters of gold-plated Buddha.', rating: 4.7, tags: ['Temple', 'Culture', 'Landmark'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Chinatown (Yaowarat)', description: 'Vibrant district with incredible street food and gold shops.', rating: 4.6, tags: ['Food', 'Culture', 'Nightlife'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Jim Thompson House', description: 'Beautiful Thai house museum of the famous silk entrepreneur.', rating: 4.5, tags: ['Museum', 'Culture', 'History'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Rooftop Bars', description: 'Sky-high bars with stunning city views and cocktails.', rating: 4.7, tags: ['Nightlife', 'Views', 'Romantic'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Thai Massage', description: 'Traditional Thai massage at temples or luxury spas.', rating: 4.8, tags: ['Wellness', 'Relaxation', 'Experience'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
  ],
  'Phuket': [
    { name: 'Big Buddha', description: '45-meter marble Buddha statue with panoramic island views.', rating: 4.6, tags: ['Temple', 'Landmark', 'Viewpoint'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Phi Phi Islands Day Trip', description: 'Visit Maya Bay and snorkel crystal-clear waters.', rating: 4.8, tags: ['Beach', 'Snorkeling', 'Day Trip'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Patong Beach', description: 'Main tourist beach with water sports and nightlife.', rating: 4.3, tags: ['Beach', 'Nightlife', 'Water Sports'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Old Phuket Town', description: 'Charming Sino-Portuguese architecture and local cafes.', rating: 4.6, tags: ['Culture', 'Photography', 'Food'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Phang Nga Bay', description: 'Stunning limestone karsts including James Bond Island.', rating: 4.8, tags: ['Nature', 'Kayaking', 'Day Trip'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Kata Beach', description: 'Beautiful family-friendly beach with good surfing.', rating: 4.5, tags: ['Beach', 'Family', 'Surfing'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Bangla Road', description: 'Famous nightlife street in Patong with bars and shows.', rating: 4.2, tags: ['Nightlife', 'Entertainment', 'Social'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Elephant Sanctuary', description: 'Ethical elephant experience in natural surroundings.', rating: 4.8, tags: ['Nature', 'Animals', 'Experience'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
  ],
  // Japan
  'Tokyo': [
    { name: 'Senso-ji Temple', description: 'Tokyo\'s oldest temple with iconic red gate and shopping street.', rating: 4.7, tags: ['Temple', 'Culture', 'Shopping'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Shibuya Crossing', description: 'World\'s busiest pedestrian crossing - a must-see Tokyo experience.', rating: 4.6, tags: ['Landmark', 'Urban', 'Photography'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Tsukiji Outer Market', description: 'Fresh sushi, seafood, and Japanese street food paradise.', rating: 4.8, tags: ['Food', 'Market', 'Experience'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Meiji Shrine', description: 'Peaceful Shinto shrine in a forested oasis in Harajuku.', rating: 4.7, tags: ['Temple', 'Nature', 'Culture'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'TeamLab Borderless', description: 'Immersive digital art museum with stunning interactive exhibits.', rating: 4.9, tags: ['Art', 'Technology', 'Experience'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Shinjuku Gyoen', description: 'Beautiful garden combining Japanese, French, and English styles.', rating: 4.6, tags: ['Nature', 'Garden', 'Relaxation'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Akihabara', description: 'Electric Town - anime, manga, electronics, and gaming paradise.', rating: 4.5, tags: ['Shopping', 'Culture', 'Unique'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Golden Gai', description: 'Narrow alleys with tiny bars in Shinjuku - unique nightlife.', rating: 4.6, tags: ['Nightlife', 'Culture', 'Experience'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Tokyo Skytree', description: '634m tower with observation decks and city panoramas.', rating: 4.5, tags: ['Viewpoint', 'Landmark', 'Photography'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Harajuku', description: 'Youth fashion capital with quirky shops and crepe stands.', rating: 4.5, tags: ['Shopping', 'Culture', 'Food'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
  ],
  'Kyoto': [
    { name: 'Fushimi Inari Shrine', description: 'Thousands of vermillion torii gates winding up a mountain.', rating: 4.9, tags: ['Temple', 'Photography', 'Hiking'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Arashiyama Bamboo Grove', description: 'Magical bamboo forest - best visited at sunrise.', rating: 4.7, tags: ['Nature', 'Photography', 'Walking'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Kinkaku-ji (Golden Pavilion)', description: 'Stunning Zen temple covered in gold leaf.', rating: 4.8, tags: ['Temple', 'Landmark', 'Photography'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Gion District', description: 'Historic geisha district with traditional wooden machiya.', rating: 4.7, tags: ['Culture', 'History', 'Walking'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Nishiki Market', description: 'Kyoto\'s kitchen - 400m of food stalls and local delicacies.', rating: 4.6, tags: ['Food', 'Market', 'Culture'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Kiyomizu-dera', description: 'Iconic wooden temple with stunning views over the city.', rating: 4.8, tags: ['Temple', 'Viewpoint', 'History'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Tea Ceremony Experience', description: 'Traditional Japanese tea ceremony in a historic tea house.', rating: 4.8, tags: ['Culture', 'Experience', 'Traditional'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Philosopher\'s Path', description: 'Scenic canal-side walk lined with cherry trees.', rating: 4.6, tags: ['Walking', 'Nature', 'Relaxation'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
  ],
  'Osaka': [
    { name: 'Dotonbori', description: 'Neon-lit food street famous for takoyaki and the Glico sign.', rating: 4.7, tags: ['Food', 'Nightlife', 'Landmark'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Osaka Castle', description: 'Historic castle with museum and beautiful park grounds.', rating: 4.6, tags: ['History', 'Landmark', 'Park'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Kuromon Market', description: 'Osaka\'s kitchen with fresh seafood and street food.', rating: 4.7, tags: ['Food', 'Market', 'Experience'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Universal Studios Japan', description: 'Theme park with Harry Potter and Nintendo worlds.', rating: 4.8, tags: ['Entertainment', 'Family', 'Fun'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Shinsekai', description: 'Retro district with kushikatsu and Tsutenkaku Tower.', rating: 4.5, tags: ['Food', 'Culture', 'Nightlife'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { name: 'Takoyaki Experience', description: 'Learn to make Osaka\'s famous octopus balls.', rating: 4.6, tags: ['Food', 'Experience', 'Culture'], image: 'https://images.pexels.com/photos/2325446/pexels-photo-2325446.jpeg?auto=compress&cs=tinysrgb&w=600' },
  ],
};
