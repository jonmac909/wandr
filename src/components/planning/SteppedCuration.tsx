...
const CITY_ATTRACTIONS: Record<string, { name: string; description: string; rating: number; tags: string[]; image: string }[]> = {
  // Thailand
  'Koh Samui': [
    { name: 'Big Buddha Temple', description: 'Iconic 12-meter golden Buddha statue at Wat Phra Yai with panoramic views.', rating: 4.6, tags: ['Temple', 'Culture', 'Landmark'], image: 'https://images.unsplash.com/photo-1552465011-b4e21bf6e79a?w=600&q=80' },
    { name: 'Ang Thong Marine Park', description: '42 stunning islands with emerald lagoons, caves, and pristine beaches.', rating: 4.8, tags: ['Nature', 'Beach', 'Adventure'], image: 'https://images.unsplash.com/photo-1537956965359-7573183d1f57?w=600&q=80' },
    { name: 'Wat Plai Laem', description: 'Colorful temple complex featuring an 18-arm Guanyin statue on the water.', rating: 4.7, tags: ['Temple', 'Culture', 'Photography'], image: 'https://images.unsplash.com/photo-1528181304800-259b08848526?w=600&q=80' },
    { name: 'Na Mueng Waterfall', description: 'Beautiful two-tiered waterfall in the jungle, great for swimming.', rating: 4.4, tags: ['Nature', 'Waterfall', 'Adventure'], image: 'https://images.unsplash.com/photo-1432405972618-c60b0225b8f9?w=600&q=80' },
    { name: 'Lamai Night Market', description: 'Vibrant night market with street food, clothes, and local crafts.', rating: 4.5, tags: ['Food', 'Shopping', 'Nightlife'], image: 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=600&q=80' },
    { name: 'Pig Island (Koh Madsum)', description: 'Charming island famous for friendly pigs on the beach.', rating: 4.6, tags: ['Beach', 'Unique', 'Family'], image: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=600&q=80' },
    { name: 'Grandfather & Grandmother Rocks', description: 'Unique rock formations on Lamai Beach with interesting shapes.', rating: 4.2, tags: ['Nature', 'Landmark', 'Beach'], image: 'https://images.unsplash.com/photo-1506953823976-52e1fdc0149a?w=600&q=80' },
    { name: 'Fisherman\'s Village', description: 'Charming area in Bophut with boutiques, restaurants, and Friday night market.', rating: 4.6, tags: ['Shopping', 'Food', 'Nightlife'], image: 'https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=600&q=80' },
    { name: 'Secret Buddha Garden', description: 'Hidden hillside garden with Buddhist statues and jungle views.', rating: 4.5, tags: ['Culture', 'Nature', 'Adventure'], image: 'https://images.unsplash.com/photo-1528181304800-259b08848526?w=600&q=80' },
    { name: 'Overlap Stone', description: 'Viewpoint with stunning panoramic views of Lamai Beach.', rating: 4.7, tags: ['Viewpoint', 'Photography', 'Nature'], image: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=600&q=80' },
  ],
  'Chiang Mai': [
    { name: 'Wat Doi Suthep', description: 'Sacred temple on a mountain with 309 steps and city views.', rating: 4.7, tags: ['Temple', 'Culture', 'Viewpoint'], image: 'https://images.unsplash.com/photo-1512553424870-a2a2d9e5ed73?w=600&q=80' },
    { name: 'Elephant Nature Park', description: 'Ethical elephant sanctuary where you can feed and bathe elephants.', rating: 4.9, tags: ['Nature', 'Animals', 'Experience'], image: 'https://images.unsplash.com/photo-1564760055775-d63b17a55c44?w=600&q=80' },
    { name: 'Night Bazaar', description: 'Famous night market with handicrafts, food, and entertainment.', rating: 4.5, tags: ['Shopping', 'Food', 'Nightlife'], image: 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=600&q=80' },
    { name: 'Old City Temples', description: 'Historic walled city with ancient temples including Wat Chedi Luang.', rating: 4.6, tags: ['Temple', 'History', 'Walking'], image: 'https://images.unsplash.com/photo-1569248979104-865ab7cd8d13?w=600&q=80' },
    { name: 'Sticky Waterfalls', description: 'Unique limestone waterfall you can climb up - the rocks are not slippery!', rating: 4.7, tags: ['Nature', 'Adventure', 'Unique'], image: 'https://images.unsplash.com/photo-1432405972618-c60b0225b8f9?w=600&q=80' },
    { name: 'Doi Inthanon', description: 'Thailand\'s highest peak with twin pagodas and cool mountain trails.', rating: 4.8, tags: ['Nature', 'Hiking', 'Viewpoint'], image: 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=600&q=80' },
    { name: 'Wua Lai Walking Street', description: 'Saturday night market famous for silver jewelry and local crafts.', rating: 4.6, tags: ['Shopping', 'Culture', 'Nightlife'], image: 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=600&q=80' },
    { name: 'Thai Cooking Class', description: 'Learn to cook authentic Thai dishes at a local cooking school.', rating: 4.9, tags: ['Food', 'Experience', 'Culture'], image: 'https://images.unsplash.com/photo-1556910103-1c02745aae4d?w=600&q=80' },
    { name: 'Wat Phra Singh', description: 'Important temple housing the revered Phra Singh Buddha image.', rating: 4.6, tags: ['Temple', 'Culture', 'History'], image: 'https://images.unsplash.com/photo-1569248979104-865ab7cd8d13?w=600&q=80' },
    { name: 'Grand Canyon Water Park', description: 'Former quarry turned into a fun water park with cliff jumping.', rating: 4.4, tags: ['Adventure', 'Swimming', 'Fun'], image: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=600&q=80' },
  ],
  'Bangkok': [
    { name: 'Grand Palace', description: 'Stunning royal palace complex with the sacred Emerald Buddha.', rating: 4.7, tags: ['Palace', 'Culture', 'History'], image: 'https://images.unsplash.com/photo-1563492065599-3520f775eeed?w=600&q=80' },
    { name: 'Wat Arun', description: 'Iconic Temple of Dawn with intricate porcelain-covered spires.', rating: 4.8, tags: ['Temple', 'Landmark', 'Photography'], image: 'https://images.unsplash.com/photo-1528181304800-259b08848526?w=600&q=80' },
    { name: 'Chatuchak Weekend Market', description: 'One of the world\'s largest markets with 15,000+ stalls.', rating: 4.6, tags: ['Shopping', 'Food', 'Experience'], image: 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=600&q=80' },
    { name: 'Khao San Road', description: 'Famous backpacker street with bars, food, and lively nightlife.', rating: 4.3, tags: ['Nightlife', 'Food', 'Social'], image: 'https://images.unsplash.com/photo-1470337458703-46ad1756a187?w=600&q=80' },
    { name: 'Floating Markets', description: 'Traditional markets on canals selling food and goods from boats.', rating: 4.5, tags: ['Culture', 'Food', 'Unique'], image: 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=600&q=80' },
    { name: 'Wat Pho', description: 'Temple of the Reclining Buddha - 46 meters of gold-plated Buddha.', rating: 4.7, tags: ['Temple', 'Culture', 'Landmark'], image: 'https://images.unsplash.com/photo-1569248979104-865ab7cd8d13?w=600&q=80' },
    { name: 'Chinatown (Yaowarat)', description: 'Vibrant district with incredible street food and gold shops.', rating: 4.6, tags: ['Food', 'Culture', 'Nightlife'], image: 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=600&q=80' },
    { name: 'Jim Thompson House', description: 'Beautiful Thai house museum of the famous silk entrepreneur.', rating: 4.5, tags: ['Museum', 'Culture', 'History'], image: 'https://images.unsplash.com/photo-1536924940846-227afb31e2a5?w=600&q=80' },
    { name: 'Rooftop Bars', description: 'Sky-high bars with stunning city views and cocktails.', rating: 4.7, tags: ['Nightlife', 'Views', 'Romantic'], image: 'https://images.unsplash.com/photo-1470337458703-46ad1756a187?w=600&q=80' },
    { name: 'Thai Massage', description: 'Traditional Thai massage at temples or luxury spas.', rating: 4.8, tags: ['Wellness', 'Relaxation', 'Experience'], image: 'https://images.unsplash.com/photo-1544161515-4ab6ce6db874?w=600&q=80' },
  ],
  'Phuket': [
    { name: 'Big Buddha', description: '45-meter marble Buddha statue with panoramic island views.', rating: 4.6, tags: ['Temple', 'Landmark', 'Viewpoint'], image: 'https://images.unsplash.com/photo-1552465011-b4e21bf6e79a?w=600&q=80' },
    { name: 'Phi Phi Islands Day Trip', description: 'Visit Maya Bay and snorkel crystal-clear waters.', rating: 4.8, tags: ['Beach', 'Snorkeling', 'Day Trip'], image: 'https://images.unsplash.com/photo-1537956965359-7573183d1f57?w=600&q=80' },
    { name: 'Patong Beach', description: 'Main tourist beach with water sports and nightlife.', rating: 4.3, tags: ['Beach', 'Nightlife', 'Water Sports'], image: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=600&q=80' },
    { name: 'Old Phuket Town', description: 'Charming Sino-Portuguese architecture and local cafes.', rating: 4.6, tags: ['Culture', 'Photography', 'Food'], image: 'https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=600&q=80' },
    { name: 'Phang Nga Bay', description: 'Stunning limestone karsts including James Bond Island.', rating: 4.8, tags: ['Nature', 'Kayaking', 'Day Trip'], image: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=600&q=80' },
    { name: 'Kata Beach', description: 'Beautiful family-friendly beach with good surfing.', rating: 4.5, tags: ['Beach', 'Family', 'Surfing'], image: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=600&q=80' },
    { name: 'Bangla Road', description: 'Famous nightlife street in Patong with bars and shows.', rating: 4.2, tags: ['Nightlife', 'Entertainment', 'Social'], image: 'https://images.unsplash.com/photo-1470337458703-46ad1756a187?w=600&q=80' },
    { name: 'Elephant Sanctuary', description: 'Ethical elephant experience in natural surroundings.', rating: 4.8, tags: ['Nature', 'Animals', 'Experience'], image: 'https://images.unsplash.com/photo-1564760055775-d63b17a55c44?w=600&q=80' },
  ],
  // Japan
  'Tokyo': [
    { name: 'Senso-ji Temple', description: 'Tokyo\'s oldest temple with iconic red gate and shopping street.', rating: 4.7, tags: ['Temple', 'Culture', 'Shopping'], image: 'https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?w=600&q=80' },
    { name: 'Shibuya Crossing', description: 'World\'s busiest pedestrian crossing - a must-see Tokyo experience.', rating: 4.6, tags: ['Landmark', 'Urban', 'Photography'], image: 'https://images.unsplash.com/photo-1542051841857-5f90071e7989?w=600&q=80' },
    { name: 'Tsukiji Outer Market', description: 'Fresh sushi, seafood, and Japanese street food paradise.', rating: 4.8, tags: ['Food', 'Market', 'Experience'], image: 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=600&q=80' },
    { name: 'Meiji Shrine', description: 'Peaceful Shinto shrine in a forested oasis in Harajuku.', rating: 4.7, tags: ['Temple', 'Nature', 'Culture'], image: 'https://images.unsplash.com/photo-1528360983277-13d401cdc186?w=600&q=80' },
    { name: 'TeamLab Borderless', description: 'Immersive digital art museum with stunning interactive exhibits.', rating: 4.9, tags: ['Art', 'Technology', 'Experience'], image: 'https://images.unsplash.com/photo-1536924940846-227afb31e2a5?w=600&q=80' },
    { name: 'Shinjuku Gyoen', description: 'Beautiful garden combining Japanese, French, and English styles.', rating: 4.6, tags: ['Nature', 'Garden', 'Relaxation'], image: 'https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?w=600&q=80' },
    { name: 'Akihabara', description: 'Electric Town - anime, manga, electronics, and gaming paradise.', rating: 4.5, tags: ['Shopping', 'Culture', 'Unique'], image: 'https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?w=600&q=80' },
    { name: 'Golden Gai', description: 'Narrow alleys with tiny bars in Shinjuku - unique nightlife.', rating: 4.6, tags: ['Nightlife', 'Culture', 'Experience'], image: 'https://images.unsplash.com/photo-1470337458703-46ad1756a187?w=600&q=80' },
    { name: 'Tokyo Skytree', description: '634m tower with observation decks and city panoramas.', rating: 4.5, tags: ['Viewpoint', 'Landmark', 'Photography'], image: 'https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?w=600&q=80' },
    { name: 'Harajuku', description: 'Youth fashion capital with quirky shops and crepe stands.', rating: 4.5, tags: ['Shopping', 'Culture', 'Food'], image: 'https://images.unsplash.com/photo-1542051841857-5f90071e7989?w=600&q=80' },
  ],
  'Kyoto': [
    { name: 'Fushimi Inari Shrine', description: 'Thousands of vermillion torii gates winding up a mountain.', rating: 4.9, tags: ['Temple', 'Photography', 'Hiking'], image: 'https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?w=600&q=80' },
    { name: 'Arashiyama Bamboo Grove', description: 'Magical bamboo forest - best visited at sunrise.', rating: 4.7, tags: ['Nature', 'Photography', 'Walking'], image: 'https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?w=600&q=80' },
    { name: 'Kinkaku-ji (Golden Pavilion)', description: 'Stunning Zen temple covered in gold leaf.', rating: 4.8, tags: ['Temple', 'Landmark', 'Photography'], image: 'https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?w=600&q=80' },
    { name: 'Gion District', description: 'Historic geisha district with traditional wooden machiya.', rating: 4.7, tags: ['Culture', 'History', 'Walking'], image: 'https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?w=600&q=80' },
    { name: 'Nishiki Market', description: 'Kyoto\'s kitchen - 400m of food stalls and local delicacies.', rating: 4.6, tags: ['Food', 'Market', 'Culture'], image: 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=600&q=80' },
    { name: 'Kiyomizu-dera', description: 'Iconic wooden temple with stunning views over the city.', rating: 4.8, tags: ['Temple', 'Viewpoint', 'History'], image: 'https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?w=600&q=80' },
    { name: 'Tea Ceremony Experience', description: 'Traditional Japanese tea ceremony in a historic tea house.', rating: 4.8, tags: ['Culture', 'Experience', 'Traditional'], image: 'https://images.unsplash.com/photo-1556910103-1c02745aae4d?w=600&q=80' },
    { name: 'Philosopher\'s Path', description: 'Scenic canal-side walk lined with cherry trees.', rating: 4.6, tags: ['Walking', 'Nature', 'Relaxation'], image: 'https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?w=600&q=80' },
  ],
  'Osaka': [
    { name: 'Dotonbori', description: 'Neon-lit food street famous for takoyaki and the Glico sign.', rating: 4.7, tags: ['Food', 'Nightlife', 'Landmark'], image: 'https://images.unsplash.com/photo-1590559899731-a382839e5549?w=600&q=80' },
    { name: 'Osaka Castle', description: 'Historic castle with museum and beautiful park grounds.', rating: 4.6, tags: ['History', 'Landmark', 'Park'], image: 'https://images.unsplash.com/photo-1590559899731-a382839e5549?w=600&q=80' },
    { name: 'Kuromon Market', description: 'Osaka\'s kitchen with fresh seafood and street food.', rating: 4.7, tags: ['Food', 'Market', 'Experience'], image: 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=600&q=80' },
    { name: 'Universal Studios Japan', description: 'Theme park with Harry Potter and Nintendo worlds.', rating: 4.8, tags: ['Entertainment', 'Family', 'Fun'], image: 'https://images.unsplash.com/photo-1536924940846-227afb31e2a5?w=600&q=80' },
    { name: 'Shinsekai', description: 'Retro district with kushikatsu and Tsutenkaku Tower.', rating: 4.5, tags: ['Food', 'Culture', 'Nightlife'], image: 'https://images.unsplash.com/photo-1590559899731-a382839e5549?w=600&q=80' },
    { name: 'Takoyaki Experience', description: 'Learn to make Osaka\'s famous octopus balls.', rating: 4.6, tags: ['Food', 'Experience', 'Culture'], image: 'https://images.unsplash.com/photo-1556910103-1c02745aae4d?w=600&q=80' },
  ],
};
