...
export function itineraryToPlanningItems(itinerary: Itinerary | null | undefined): PlanningItem[] {
  ...
  itinerary.route.bases.forEach((base) => {
    ...
    if (!citySet.has(cityName)) {
      ...
      items.push({
        ...
        imageUrl: `https://picsum.photos/seed/${encodeURIComponent(cityName)}-city/400/300`,
  ...
  itinerary.route.bases.forEach((base) => {
    if (base.accommodation?.name) {
      items.push({
        ...
        imageUrl: `https://picsum.photos/seed/${encodeURIComponent(base.accommodation.name)}-hotel/400/300`,
        category: 'hotels',
    ...
    day.blocks.forEach((block, blockIndex) => {
      if (block.activity) {
        ...
        items.push({
          ...
          imageUrl: `https://picsum.photos/seed/${encodeURIComponent(activity.name)}-activity/400/300`,
          category,
          rating: undefined,
  ...
  itinerary.foodLayer.forEach((food) => {
    ...
    items.push({
      ...
      imageUrl: `https://picsum.photos/seed/${encodeURIComponent(food.name)}-food/400/300`,
