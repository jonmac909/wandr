...
export const MOCK_ACTIVITIES: Record<string, GeneratedActivity[]> = {
  ...
  'Tokyo': [
    // Asakusa Area
    { id: 'tyo-1', name: 'Senso-ji Temple', type: 'attraction', description: 'Tokyo\'s oldest Buddhist temple with iconic Thunder Gate', imageUrl: null, suggestedTime: '09:00', duration: 90, openingHours: '6AM-5PM', neighborhood: 'Asakusa', matchScore: 95, matchReasons: ['Historic temple'], priceRange: '$', tags: ['temple', 'history'] },
    { id: 'tyo-2', name: 'Nakamise Shopping Street', type: 'activity', description: 'Traditional shopping street leading to Senso-ji with snacks and souvenirs', imageUrl: null, suggestedTime: '10:30', duration: 60, openingHours: '9AM-7PM', neighborhood: 'Asakusa', matchScore: 88, matchReasons: ['Near Senso-ji'], priceRange: '$', tags: ['shopping', 'snacks'] },
    { id: 'tyo-3', name: 'Tokyo Skytree', type: 'attraction', description: 'Tallest tower in Japan with observation decks and stunning city views', imageUrl: null, suggestedTime: '11:30', duration: 120, openingHours: '10AM-9PM', neighborhood: 'Sumida', matchScore: 92, matchReasons: ['Panoramic views'], priceRange: '$$', tags: ['viewpoint', 'landmark'] },
    // Shibuya/Harajuku Area
    { id: 'tyo-4', name: 'Shibuya Crossing', type: 'attraction', description: 'World\'s busiest pedestrian crossing - iconic Tokyo experience', imageUrl: null, suggestedTime: '18:00', duration: 60, openingHours: '24 hours', neighborhood: 'Shibuya', matchScore: 89, matchReasons: ['Iconic Tokyo'], priceRange: '$', tags: ['landmark', 'photography'] },
    { id: 'tyo-5', name: 'Meiji Shrine', type: 'attraction', description: 'Serene Shinto shrine in forested area dedicated to Emperor Meiji', imageUrl: null, suggestedTime: '08:00', duration: 60, openingHours: 'Sunrise-Sunset', neighborhood: 'Harajuku', matchScore: 88, matchReasons: ['Peaceful oasis'], priceRange: '$', tags: ['shrine', 'nature'] },
    { id: 'tyo-6', name: 'Takeshita Street', type: 'activity', description: 'Colorful pedestrian street famous for youth fashion and crepes', imageUrl: null, suggestedTime: '14:00', duration: 90, openingHours: '10AM-8PM', neighborhood: 'Harajuku', matchScore: 85, matchReasons: ['Youth culture'], priceRange: '$', tags: ['shopping', 'fashion'] },
    { id: 'tyo-7', name: 'Yoyogi Park', type: 'attraction', description: 'Large urban park perfect for picnics and people-watching', imageUrl: null, suggestedTime: '10:00', duration: 60, openingHours: '24 hours', neighborhood: 'Harajuku', matchScore: 82, matchReasons: ['Relaxing'], priceRange: '$', tags: ['park', 'nature'] },
    // Shinjuku Area
    { id: 'tyo-8', name: 'Shinjuku Gyoen', type: 'attraction', description: 'Beautiful garden with Japanese, French, and English landscape styles', imageUrl: null, suggestedTime: '09:00', duration: 90, openingHours: '9AM-4PM', neighborhood: 'Shinjuku', matchScore: 90, matchReasons: ['Stunning gardens'], priceRange: '$', tags: ['garden', 'nature'] },
    { id: 'tyo-9', name: 'Tokyo Metropolitan Government Building', type: 'attraction', description: 'Free observation decks with panoramic views of Tokyo and Mt. Fuji', imageUrl: null, suggestedTime: '17:00', duration: 60, openingHours: '9:30AM-11PM', neighborhood: 'Shinjuku', matchScore: 87, matchReasons: ['Free views'], priceRange: '$', tags: ['viewpoint', 'free'] },
    { id: 'tyo-10', name: 'Golden Gai', type: 'activity', description: 'Maze of tiny bars in narrow alleys - unique nightlife experience', imageUrl: null, suggestedTime: '20:00', duration: 120, openingHours: '7PM-2AM', neighborhood: 'Shinjuku', matchScore: 86, matchReasons: ['Nightlife'], priceRange: '$$', tags: ['nightlife', 'bars'] },
    { id: 'tyo-11', name: 'Omoide Yokocho', type: 'activity', description: 'Atmospheric alley of tiny yakitori stalls near Shinjuku Station', imageUrl: null, suggestedTime: '19:00', duration: 90, openingHours: '5PM-12AM', neighborhood: 'Shinjuku', matchScore: 84, matchReasons: ['Local atmosphere'], priceRange: '$', tags: ['food', 'local'] },
    // Akihabara/Ueno Area
    { id: 'tyo-12', name: 'Akihabara Electric Town', type: 'activity', description: 'Electronics and anime/manga paradise with multi-story shops', imageUrl: null, suggestedTime: '13:00', duration: 120, openingHours: '10AM-9PM', neighborhood: 'Akihabara', matchScore: 88, matchReasons: ['Otaku culture'], priceRange: '$$', tags: ['anime', 'electronics'] },
    { id: 'tyo-13', name: 'Ueno Park', type: 'attraction', description: 'Large park with museums, temples, and zoo - cherry blossom hotspot', imageUrl: null, suggestedTime: '10:00', duration: 120, openingHours: '5AM-11PM', neighborhood: 'Ueno', matchScore: 86, matchReasons: ['Museums nearby'], priceRange: '$', tags: ['park', 'culture'] },
    { id: 'tyo-14', name: 'Tokyo National Museum', type: 'attraction', description: 'Japan\'s oldest and largest museum with samurai swords and art', imageUrl: null, suggestedTime: '10:00', duration: 180, openingHours: '9:30AM-5PM', neighborhood: 'Ueno', matchScore: 89, matchReasons: ['World-class art'], priceRange: '$$', tags: ['museum', 'history'] },
    { id: 'tyo-15', name: 'Ameya-Yokocho Market', type: 'activity', description: 'Bustling market street under train tracks with bargains galore', imageUrl: null, suggestedTime: '14:00', duration: 90, openingHours: '10AM-7PM', neighborhood: 'Ueno', matchScore: 83, matchReasons: ['Local market'], priceRange: '$', tags: ['market', 'shopping'] },
    // Odaiba/Waterfront
    { id: 'tyo-16', name: 'teamLab Borderless', type: 'attraction', description: 'Immersive digital art museum with interactive light installations', imageUrl: null, suggestedTime: '14:00', duration: 180, openingHours: '10AM-7PM', neighborhood: 'Odaiba', matchScore: 91, matchReasons: ['Unique experience'], priceRange: '$$', tags: ['art', 'interactive'] },
    { id: 'tyo-17', name: 'Odaiba Beach', type: 'attraction', description: 'Man-made beach with views of Rainbow Bridge and Statue of Liberty replica', imageUrl: null, suggestedTime: '16:00', duration: 60, openingHours: '24 hours', neighborhood: 'Odaiba', matchScore: 80, matchReasons: ['Sunset views'], priceRange: '$', tags: ['beach', 'views'] },
    // Ginza/Tsukiji Area
    { id: 'tyo-18', name: 'Tsukiji Outer Market', type: 'activity', description: 'Famous market area with fresh sushi and Japanese street food', imageUrl: null, suggestedTime: '07:00', duration: 120, openingHours: '5AM-2PM', neighborhood: 'Tsukiji', matchScore: 93, matchReasons: ['Fresh sushi'], priceRange: '$$', tags: ['food', 'market'] },
    { id: 'tyo-19', name: 'Ginza District', type: 'activity', description: 'Upscale shopping district with department stores and galleries', imageUrl: null, suggestedTime: '15:00', duration: 120, openingHours: '11AM-8PM', neighborhood: 'Ginza', matchScore: 82, matchReasons: ['Luxury shopping'], priceRange: '$$$', tags: ['shopping', 'luxury'] },
    // Roppongi Area
    { id: 'tyo-20', name: 'Mori Art Museum', type: 'attraction', description: 'Contemporary art museum on 53rd floor with city views', imageUrl: null, suggestedTime: '11:00', duration: 120, openingHours: '10AM-10PM', neighborhood: 'Roppongi', matchScore: 85, matchReasons: ['Modern art'], priceRange: '$$', tags: ['museum', 'art'] },
    { id: 'tyo-21', name: 'Tokyo Tower', type: 'attraction', description: 'Iconic red and white tower inspired by Eiffel Tower', imageUrl: null, suggestedTime: '18:00', duration: 90, openingHours: '9AM-11PM', neighborhood: 'Minato', matchScore: 87, matchReasons: ['Classic landmark'], priceRange: '$$', tags: ['viewpoint', 'landmark'] },
    // More diverse attractions
    { id: 'tyo-22', name: 'Imperial Palace East Gardens', type: 'attraction', description: 'Beautiful gardens on former Edo Castle grounds - free entry', imageUrl: null, suggestedTime: '09:00', duration: 90, openingHours: '9AM-4PM', neighborhood: 'Chiyoda', matchScore: 86, matchReasons: ['Historic gardens'], priceRange: '$', tags: ['garden', 'history'] },
    { id: 'tyo-23', name: 'Yanaka Ginza', type: 'activity', description: 'Charming old-Tokyo shopping street with traditional atmosphere', imageUrl: null, suggestedTime: '14:00', duration: 90, openingHours: '10AM-6PM', neighborhood: 'Yanaka', matchScore: 84, matchReasons: ['Old Tokyo charm'], priceRange: '$', tags: ['shopping', 'traditional'] },
    { id: 'tyo-24', name: 'Nezu Shrine', type: 'attraction', description: 'Beautiful shrine famous for thousands of vermillion torii gates', imageUrl: null, suggestedTime: '10:00', duration: 60, openingHours: '6AM-5PM', neighborhood: 'Bunkyo', matchScore: 83, matchReasons: ['Torii gates'], priceRange: '$', tags: ['shrine', 'photography'] },
    { id: 'tyo-25', name: 'Edo-Tokyo Museum', type: 'attraction', description: 'Interactive museum showcasing Tokyo\'s history from Edo period', imageUrl: null, suggestedTime: '10:00', duration: 150, openingHours: '9:30AM-5:30PM', neighborhood: 'Ryogoku', matchScore: 85, matchReasons: ['History buffs'], priceRange: '$$', tags: ['museum', 'history'] },
    { id: 'tyo-26', name: 'Ryogoku Sumo District', type: 'activity', description: 'Sumo wrestling heartland with stables and chanko nabe restaurants', imageUrl: null, suggestedTime: '11:00', duration: 120, openingHours: 'Varies', neighborhood: 'Ryogoku', matchScore: 82, matchReasons: ['Unique culture'], priceRange: '$$', tags: ['sumo', 'culture'] },
    { id: 'tyo-27', name: 'Shimokitazawa', type: 'activity', description: 'Bohemian neighborhood with vintage shops, cafes, and live music', imageUrl: null, suggestedTime: '14:00', duration: 120, openingHours: '11AM-9PM', neighborhood: 'Shimokitazawa', matchScore: 84, matchReasons: ['Hip neighborhood'], priceRange: '$', tags: ['vintage', 'cafes'] },
    { id: 'tyo-28', name: 'Gotokuji Temple', type: 'attraction', description: 'Lucky cat temple with thousands of maneki-neko statues', imageUrl: null, suggestedTime: '10:00', duration: 60, openingHours: '6AM-6PM', neighborhood: 'Setagaya', matchScore: 81, matchReasons: ['Instagram-worthy'], priceRange: '$', tags: ['temple', 'cats'] },
    { id: 'tyo-29', name: 'Kappabashi Kitchen Street', type: 'activity', description: 'Kitchen supply district with fake food samples and chef knives', imageUrl: null, suggestedTime: '11:00', duration: 90, openingHours: '9AM-5PM', neighborhood: 'Taito', matchScore: 80, matchReasons: ['Unique souvenirs'], priceRange: '$$', tags: ['shopping', 'food'] },
    { id: 'tyo-30', name: 'Zojoji Temple', type: 'attraction', description: 'Historic temple with Tokyo Tower backdrop - great photo spot', imageUrl: null, suggestedTime: '09:00', duration: 45, openingHours: '6AM-5:30PM', neighborhood: 'Minato', matchScore: 79, matchReasons: ['Photo spot'], priceRange: '$', tags: ['temple', 'photography'] },
  ],
  'Kyoto': [
    {
      id: 'kyo-1',
