...
// City images - all verified working from DestinationInspiration and data files
...
// Site/attraction images - verified
export const SITE_IMAGES: Record<string, string> = {
  ...
  'Gothic Quarter': 'https://images.unsplash.com/photo-1583422409516-2895a77efded?w=600&q=80',
